...
## Purpose
CubeMars AK45-36 KV80 액추에이터 **최대 6대(ID1~ID6)** 를 Linux + CANable(SocketCAN) 환경에서 Servo 모드 CAN으로 동시 제어하는 C++ 프로젝트. MIT 모드는 사용하지 않는다. 프로토콜 근거는 CubeMars AK Series Module Driver Manual V1.0.18(2026.01.19).
